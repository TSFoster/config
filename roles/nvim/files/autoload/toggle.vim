...
function! toggle#quickfixList(...) abort
  if a:0 == 0 || !a:1
...
function! s:BufferCount() abort abort
    return len(filter(range(1, bufnr('$')), 'buflisted(v:val)'))
endfunction

function! toggle#locationList(...) abort
...
function! toggle#inccommand() abort
