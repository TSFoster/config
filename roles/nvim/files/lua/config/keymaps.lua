...
keymap.set("n", "<Leader><Leader>x", "<Cmd>xall<CR>", { desc = "Write and quit all windows" })
...
if fterm then
  ...
  local codex_term = fterm:new({ cmd = vim.fn.stdpath("config") .. "/bin/asdf-codex", width = 0.9, height = 0.9 })
