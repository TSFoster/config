...
.PHONY: help bootstrap collections install run check syntax nvim-pack shells dotfiles ssh dev_tools macos nvim nvim_files hammerspoon macos_navigation fonts dictionaries java macos_apps alfred nvim_lsp
...
shells dotfiles ssh dev_tools macos nvim nvim_files hammerspoon macos_navigation fonts dictionaries java macos_apps alfred nvim_lsp:
